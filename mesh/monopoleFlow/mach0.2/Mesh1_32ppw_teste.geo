...
//+
Point(5) = {-rinner, -rinner, 0, 1.0};
//+
// Point(6) = {0, rinner, 0, 1.0};
// //+
// Point(7) = {0, -rinner, 0, 1.0};
...
//+
// Point(12) = {0, rout, 0, 1.0};
// //+
// Point(13) = {0, -rout, 0, 1.0};
...
// // Linha divisória dos retângulos e das circunferências
// Line(13) = {11, 10};
// //+
// Line(14) = {10, 12};
// //+

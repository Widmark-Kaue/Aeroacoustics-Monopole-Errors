...
Pinner      = DefineNumber[3, Name "Parameters/rinner"];
Pmiddle     = DefineNumber[7.5,         Name "Parameters/rmiddle"];
Pout        = DefineNumber[15,         Name "Parameters/rout"];

rinner      = Pinner*lambdaD;
rmiddle     = Pmiddle*lambdaD;
rout        = Pout*lambdaD;         
cos45       = 0.707106781; 
